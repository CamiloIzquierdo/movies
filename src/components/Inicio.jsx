...
export const Inicio = () => {
    ...
    const postPeli = async () => {
        if (nombre) {
            ...
            const response = await usersService.postInicio(body);
                    ...
                    {!formSpinner ? (
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex gap-5 w-full justify-center">
                                {/*  <button
                                    className="bg-sky-600 text-white px-2 rounded-md font-bold py-1"
                                    disabled
                                >
                                    Publicar
                                </button> */}
                                <span>Deshabilitado momentaneamente</span>
                            </div>
                        </div>
                    ) : (
                        <div>
